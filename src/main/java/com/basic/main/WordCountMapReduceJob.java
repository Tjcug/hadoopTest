 ...
 * 简单的MapReduce WordCount任务
 * 提交任务 hadoop 提交任务 hadoop jar hadoopTest-1.0-SNAPSHOT.jar com.basic.main.WordCountMapReduceJob /user/root/wordcount/input /user/root/wordcount/output
 */
