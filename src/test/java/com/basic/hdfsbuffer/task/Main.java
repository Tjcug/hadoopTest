 ...
 */
public class Main {
    private static final ThreadPoolExecutor executor = new ThreadPoolExecutor(10, 20, 200, TimeUnit.MILLISECONDS,
            new LinkedBlockingQueue<Runnable>());

    @Test
    public void testKafaCachePool() throws IOException, InterruptedException {
    ...
    @Test
    public void testBufferLineReader() throws Exception {
        DataInputFormat dataInputFormat=new DataInputFormat();
